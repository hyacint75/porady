...
class HtmlExportMixin:
    ...
    <head>
        <meta charset="utf-8">
        <title>Přehled proškolených pracovníků</title>
        <style>
            body {{
                color: #1f2933;
    ...
    <body>
        <h1>Přehled proškolených pracovníků</h1>
        <div class="summary">
    ...
    def print_selected_certificate(self):
        ...
        if not selection:
            messagebox.showwarning("Není vybrán pracovník", "V přehledu nejprve označte pracovníka.")
            return
    ...
    <head>
        <meta charset="utf-8">
        <title>Potvrzení o proškolení BOZP a PO</title>
        <style>
            body {{
                color: #1f2933;
                font-family: Arial, sans-serif;
    ...
    <body>
        <div class="top">
            {logo_html}
            <h1>Potvrzení o proškolení BOZP a PO</h1>
        </div>
        <p>
            Potvrzujeme, že níže uvedený pracovník externí firmy absolvoval školení
            bezpečnosti a ochrany zdraví při práci a požární ochrany pro vstup a práci na pracovišti.
        </p>
        <table>
            <tr><th>Pracovník</th><td>{escape(str(row['pracovnik']))}</td></tr>
            <tr><th>Externí firma</th><td>{escape(str(row['firma']))}</td></tr>
            <tr><th>Školitel / odpovědná osoba</th><td>{escape(str(row['skolitel']))}</td></tr>
        ...
        <p>
            Pracovník byl seznámen se základními pravidly pohybu po pracovišti,
            používáním OOPP, postupy pro rizikové práce, požární ochranou,
            hlášením mimořádných událostí a zásadami první pomoci.
        </p>
        <div class="signatures">
            <div class="signature">Podpis pracovníka</div>
