...
class TrainingAppUiMixin:
    ...
    def _build_layout(self):
        ...
        ttk.Label(header, text="Školení BOZP a PO pro pracovníky externí firmy", style="Header.TLabel").grid(
            row=0, column=1, sticky="w"
        )
        ttk.Label(
            header,
            text="Projít kapitoly, vyplnit test a uložit záznam o proškolení.",
        ...
        self._build_handover_overview_tab()
    ...
    def _build_info_tab(self):
        ...
        fields = [
            ("Jméno a příjmení pracovníka", self.worker_name),
            ("Externí firma", self.company_name),
            ("Školitel / odpovědná osoba", self.trainer_name),
        ]
    ...
    def _build_results_tab(self):
        ...
        ttk.Button(actions, text="Nový pracovník", command=self.reset_form).pack(side="left", padx=8)
    ...
    def _build_overview_tab(self):
        ...
        header.pack(fill="x")
        ttk.Label(header, text="Přehled proškolených pracovníků", style="Title.TLabel").pack(side="left")
    ...
    def _build_handover_tab(self):
        ...
        fields = [
            ...
            ("Externí firma", self.handover_company),
    ...
    def _build_risks_tab(self):
        ...
        fields = [
            ...
            ("Externí firma", self.risk_company),
